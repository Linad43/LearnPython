...
def transactions_test() -> list[Transaction]:
    ...
    return [
        Transaction(
            ...
            operationAmount=OperationAmount(amount="31957.58", currency=Currency(name="руб.", code="RUB")),
        ...
        Transaction(
            ...
            operationAmount=OperationAmount(amount="8221.37", currency=Currency(name="USD", code="USD")),
            description="Перевод организации",
        ...
        Transaction(
            ...
            operationAmount=OperationAmount(amount="48223.05", currency=Currency(name="руб.", code="RUB")),
        ...
        Transaction(
            ...
            operationAmount=OperationAmount(amount="43318.34", currency=Currency(name="руб.", code="RUB")),
            description="Перевод со счета на счет",
